 ...
 * B24-3/B24-5 (passage 24) : anneau passé de mousse (primary-on-dark, réservé au côté élève)
 ...
 * B41-10 (passage 41, DA contexte vierge) : l'initiale empruntait Fraunces (`font-display`) à une
 ...
 * Fixe alors : IBM Plex Mono 600 (`font-mono font-semibold`), à SEULEMENT 3 paliers discrets
 ...
 * la graisse (IBM Plex Mono 600) ne changent toujours pas d'une page à l'autre — seule la TAILLE
 ...
 * fonte d'IBM Plex Mono), pas juste la hauteur de capitale — mesurée ~1,30× le `font-size` calculé,
