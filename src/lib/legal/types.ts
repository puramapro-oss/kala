 ...
 * de `packages/legal/src/` dans son propre `src/` (patron copy-in, cf README.md).
 */
...
export interface LegalAppConfig {
  ...
  aChatIA: boolean;
  /** Clauses additionnelles propres au modèle d'affaires de l'app (ex: KALA §3-6 tarif/annulation).
